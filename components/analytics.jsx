export default function Analytics() {
    ...
    const google = `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag('js',new Date());gtag('config','G-XFQZ8KB23B');`;
    return (
        <>
            {/* 51.la */}
            <script dangerouslySetInnerHTML={{ __html: _51la }} />
            {/* Google Analytics */}
            <script async src="https://www.googletagmanager.com/gtag/js?id=G-XFQZ8KB23B"></script>
