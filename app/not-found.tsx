...
export default function NotFound() {
    return (
        <div className="no-file-found flex flex-col items-center justify-center rounded-lg pt-40 text-center">
            <Svg />
            <h3 className="mt-4 text-xl font-medium text-gray-700 dark:text-gray-200">404 Not Found</h3>
            <p className="mt-2 text-gray-500 dark:text-gray-400">Whoops! That page doesn’t exist.</p>
        </div>
    );
}
